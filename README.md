...
A deep learning system for detecting AI-generated (deepfake) face images using Convolutional Neural Networks. Supports a custom CNN built from scratch and a fine-tuned ResNet50 via transfer learning.
...
Dolhansky et al., The DeepFake Detection Challenge (DFDC), 2020
